<?php
    ...
    try {
        ...
        $sql = "SELECT Product_ID, Product_Name, Product_Price, Product_Image_Link, Product_Page_Link FROM Product";
        $stmt = $pdo->query($sql);
...
<head>
    ...
    <title>The Skincare Plug - Home</title>
...
<body>
    ...
    <main>
        <video class="sale_video" autoplay muted loop playsinline width="30%" height="auto">
            <source src="images/sale_banner.mov" type="video/mp4">
        </video>
        <h3>Explore our wide range of skincare products designed to nourish and revitalize your skin.</h3>
