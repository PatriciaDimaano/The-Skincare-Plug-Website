...
<body>
    ...
    <main>
        <h1>User Account</h1>
        <?php
                echo "<p>Welcome, " . htmlspecialchars($_SESSION['user_FName']) . " " . htmlspecialchars($_SESSION['user_LName']) . "!</p>";
                echo "<p>Email: " . htmlspecialchars($_SESSION['user_Email']) . "</p>";
                echo "<p>Address: " . htmlspecialchars($_SESSION['user_Address']) . ", " . htmlspecialchars($_SESSION['user_City']) . ", " . htmlspecialchars($_SESSION['user_State']) . ", " . htmlspecialchars($_SESSION['user_Country']) . "</p>";
                echo "<p>Birthdate: " . htmlspecialchars($_SESSION['user_Birthdate']) . "</p>";
                echo "<a href='logout.php'>Logout from Account</a>";
        ?>
    </main>
